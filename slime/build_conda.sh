...
# create conda. Reuse an existing micromamba installation when available and
# initialize it directly so headless AutoDL sessions do not source a MOTD that
# calls nvidia-smi while no GPU is attached.
