...
class BaseAdapter:
    ...
    def __init__(
        ...
        *,
        ...
        self._sid_termination_reason: dict[str, str] = {}
    ...
    def open_session(
        ...
        *,
        ...
        self._sid_termination_reason.pop(sid, None)
    ...
    def session_turn_count(self, sid: str) -> int:
        """Return completed, trajectory-backed model turns for one session."""
        return int(self.manager.turn_count(sid))

    def session_termination_reason(self, sid: str) -> str | None:
        """Return a structured adapter-side terminal reason, if one was set."""
        return self._sid_termination_reason.get(sid)
    ...
    def _check_turn_cap(self, sid: str) -> web.Response | None:
        ...
        if prior >= cap:
            self._sid_termination_reason[sid] = "turn_limit"
